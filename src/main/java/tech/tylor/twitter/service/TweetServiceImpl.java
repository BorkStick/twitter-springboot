...
import tech.tylor.twitter.repository.TagRepository;
import tech.tylor.twitter.repository.TweetRepository;
        ...
        for (Tweet tweet : tweets) {
            ...
            for (String tag : tags) {
                message = message.replaceAll(tag,
                        "<a class=\"tag\" href=\"/meeps/" + tag.substring(1).toLowerCase() + "\">" + tag + "</a>");
            }
